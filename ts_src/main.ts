...
import { Links, Link, Ping, YLSrcom } from './bot/modules';
import * as Service from './services';
import { PERMISSIONS, AccessRestrictions } from './discord';
...
bot.subscribe('login', (chLogger: Service.Logger) => {
    ...
    const httpService = new Service.HttpsRequest(chLogger);
    ...
    const ylsr =        YLSrcom(respondService, ylService, chLogger);
